...
--
ALTER TABLE `RewritingHistory`
  ADD CONSTRAINT `history_translation_key` FOREIGN KEY (`translation_id`) REFERENCES `Translation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `history_user_key` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
